...
CREATE TABLE IF NOT EXISTS public.alarm_challenges (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
DROP POLICY IF EXISTS "Users can create their own alarms" ON public.alarms;
...
DROP POLICY IF EXISTS "Users can view their own challenges" ON public.alarm_challenges;
CREATE POLICY "Users can view their own challenges"
  ON public.alarm_challenges FOR SELECT
  USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can create their own challenges" ON public.alarm_challenges;
CREATE POLICY "Users can create their own challenges"
  ON public.alarm_challenges FOR INSERT
  WITH CHECK (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can update their own challenges" ON public.alarm_challenges;
...
DROP POLICY IF EXISTS "Users can view configs for their tasks" ON public.reminder_configs;
...
DROP POLICY IF EXISTS "Users can create configs for their tasks" ON public.reminder_configs;
...
DROP POLICY IF EXISTS "Users can update configs for their tasks" ON public.reminder_configs;
...
DROP POLICY IF EXISTS "Users can delete configs for their tasks" ON public.reminder_configs;
